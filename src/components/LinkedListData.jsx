  ...
  return (
    <div className="linkedMainContainer">
      ...
      <div className="frame1_data">
        ...
        <img src={nodeImg} alt="Node Diagram" />
      </div>
      ...
      <div className="frame2_data">
        ...
        <div className="insert_at_head">
          <img src={insertHead} alt="Node Diagram" id="image" />
          <div id="text-content">
            <ul>
              <li>
        ...
        <div className="insert_at_pos">
          <img src={insertPos} alt="Node Diagram" id="image" />
          <div id="text-content">
            <ul>
              <li>
      ...
      <div className="frame3_data">
        ...
        <div className="delete_at_head">
          <img src={deleteHead} alt="Node Diagram" id="image" />
          <div id="text-content">
            <ul>
              <li>
            ...
            <ul>
              ...
              <li>Free the memory of the old head node.</li>
              <button onClick={visualizeLink} className="btn-visualize">
                Visualize
              </button>
            </ul>
        ...
        <div className="delete_at_pos">
          <img src={deletePos} alt="Node Diagram" id="image" />
          <div id="text-content">
            <ul>
              <li>
      ...
      <div className="frame4_data">
        ...
        <div className="update_by_val">
          <img src={updateVal} alt="Node Diagram" id="image" />
          <div id="text-content">
            <ul>
              <li>
      ...
      <div className="frame5_data">
        ...
        <div className="update_by_val">
          <img src={searchVal} alt="Node Diagram" id="image" />
          <div id="text-content">
            <ul>
              <li>
